...
function isStatePlainEnough(a) {
  ...
  if (!a) return false;
  if ((typeof a === 'undefined' ? 'undefined' : _typeof$1(a)) !== 'object') return false;
...
function _hasStorage(storageType) {
  if ((typeof window === 'undefined' ? 'undefined' : _typeof$2(window)) !== 'object' || !(storageType in window)) {
    return false;
  }
...
function syncHistoryWithStore(history, store) {
  ...
  if (adjustUrlOnReplay) {
    var handleStoreChange = function handleStoreChange() {
      ...
      history.push(_extends({}, locationInStore, {
        action: 'PUSH'
      }));
...
var lib_9 = lib$1.routerReducer;
var lib_11 = lib$1.syncHistoryWithStore;
...
var ACTIVATE_API_KEY = "ACTIVATE_API_KEY";
var ACTIVATE_API_KEY_SUCCESS = "ACTIVATE_API_KEY_SUCCESS";
var ACTIVATE_API_KEY_FAILURE = "ACTIVATE_API_KEY_FAILURE";

var REMOVE_API_KEY = "REMOVE_API_KEY";

var emptyLogin = { apiKey: "", email: "" };

function login() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : emptyLogin;
  var action = arguments[1];
...
var NOTIFICATION_REMOVE = "NOTIFICATION_REMOVE";

var NOTIFICATION_LEVEL_INFO = "NOTIFICATION_LEVEL_INFO";
var NOTIFICATION_LEVEL_WARNING = "NOTIFICATION_LEVEL_WARNING";
...
function notifications() {
  ...
  switch (action.type) {
    case NOTIFICATION_ADD:
      return lodash.concat(state, [{
        key: action.key,
        message: action.message,
        level: action.level
      }]);
    case NOTIFICATION_REMOVE:
      return lodash.filter(state, function (n) {
...
var Store = compose(autoRehydrate())(createStore)(combineReducers({
  login: login,
...
var History = lib_11(createBrowserHistory(), Store);
...
var Footer = function (_Component) {
  ...
  createClass(Footer, [{
    ...
    value: function render$$1(_ref, _ref2) {
      ...
      return h(
        "footer",
        { "class": "ph3 pv2 ph5-m w-100 mid-gray absolute bottom-1" },
        h(
          "small",
          { "class": "f6 db tc" },
          "\xA9 2017 ",
        ...
        h(
          ...
          h(
            "a",
            {
              ...
              target: "_blank",
              "class": "f6 dib ph2 link mid-gray dim bottom-0 lh0",
              style: "height: 16px;"
            },
            h(
              "svg",
              ...
              h("path", { d: "M8 0C3.58 0 0 3.582 0 8c0 3.535 2.292 6.533 5.47 7.59.4.075.547-.172.547-.385 0-.19-.007-.693-.01-1.36-2.226.483-2.695-1.073-2.695-1.073-.364-.924-.89-1.17-.89-1.17-.725-.496.056-.486.056-.486.803.056 1.225.824 1.225.824.714 1.223 1.873.87 2.33.665.072-.517.278-.87.507-1.07-1.777-.2-3.644-.888-3.644-3.953 0-.873.31-1.587.823-2.147-.083-.202-.358-1.015.077-2.117 0 0 .672-.215 2.2.82.638-.178 1.323-.266 2.003-.27.68.004 1.364.092 2.003.27 1.527-1.035 2.198-.82 2.198-.82.437 1.102.163 1.915.08 2.117.513.56.823 1.274.823 2.147 0 3.073-1.87 3.75-3.653 3.947.287.246.543.735.543 1.48 0 1.07-.01 1.933-.01 2.195 0 .215.144.463.55.385C13.71 14.53 16 11.534 16 8c0-4.418-3.582-8-8-8" })
            )
          ),
          h(
            "a",
            { href: "/terms-and-conditions", "class": "f6 dib ph2 link mid-gray dim" },
            "terms and conditions"
          ),
          h(
            "a",
            { href: "/promise", "class": "f6 dib ph2 link mid-gray dim" },
            "promise"
          ),
          h(
            "a",
            { href: "/privacy-policy", "class": "f6 dib ph2 link mid-gray dim" },
            "privacy"
          )
        )
      );
...
function activateApiKey(email, apiKey) {
...
var ajax = function (params, callback) {
  ...
  if (body) {
    ...
    if (!commonjsGlobal.FormData || !(body instanceof commonjsGlobal.FormData)) {
...
function getRequest(cors) {
  ...
  if (cors && commonjsGlobal.XDomainRequest && !/MSIE 1/.test(navigator.userAgent))
...
function RequestLoginToken(email) {
  ajax({
    ...
    if (code === 0) {
      Store.dispatch(addNotification(NOTIFICATION_LEVEL_INFO, "unable to connect to internet"));
    ...
    if (parsed.status === "error") {
      Store.dispatch(addNotification(NOTIFICATION_LEVEL_WARNING, parsed.error));
...
function ActivateLoginToken(dispatch, token) {
  ajax({
    ...
    if (code === 0) {
      dispatch(addNotification(NOTIFICATION_LEVEL_INFO, "unable to connect to internet"));
...
var Login = function (_Component) {
  ...
  createClass(Login, [{
    ...
    value: function render$$1(props, state) {
      return h(
        "div",
        { "class": "fl w-100 pa5 h-auto" },
        h(
          "form",
          { "class": "measure center", onSubmit: this.handleSubmit.bind(this) },
          h(
            "fieldset",
...
selectorFactory) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    invariant$1(typeof WrappedComponent == 'function', 'You must pass a component to the function returned by ' + ('connect. Instead received ' + JSON.stringify(WrappedComponent)));
    ...
    var Connect = function (_Component) {
      ...
      function Connect(props, context) {
        ...
        invariant$1(_this.store, 'Could not find "' + storeKey + '" in either the context or props of ' + ('"' + displayName + '". Either wrap the root component in a <Provider>, ') + ('or explicitly pass "' + storeKey + '" as a prop to "' + displayName + '".'));
      ...
      Connect.prototype.getWrappedInstance = function getWrappedInstance() {
        invariant$1(withRef, 'To access the wrapped instance, you need to specify ' + ('{ withRef: true } in the options argument of the ' + methodName + '() call.'));
      ...
      Connect.prototype.addExtraProps = function addExtraProps(props) {
        ...
        var withExtras = _extends$5({}, props);
...
function shallowEqual(objA, objB) {
  ...
  if ((typeof objA === 'undefined' ? 'undefined' : _typeof$5(objA)) !== 'object' || objA === null || (typeof objB === 'undefined' ? 'undefined' : _typeof$5(objB)) !== 'object' || objB === null) {
    return false;
  }
...
/** Detect free variable `global` from Node.js. */
var freeGlobal$2 = (typeof global === 'undefined' ? 'undefined' : _typeof$5(global)) == 'object' && global && global.Object === Object && global;
...
function whenMapDispatchToPropsIsObject(mapDispatchToProps) {
  return mapDispatchToProps && (typeof mapDispatchToProps === 'undefined' ? 'undefined' : _typeof$5(mapDispatchToProps)) === 'object' ? wrapMapToPropsConstant(function (dispatch) {
...
function match(arg, factories, name) {
  ...
  return function (dispatch, options$$1) {
    throw new Error('Invalid value of type ' + (typeof arg === 'undefined' ? 'undefined' : _typeof$5(arg)) + ' for ' + name + ' argument when connecting component ' + options$$1.wrappedComponentName + '.');
  };
}
...
var index$1$1 = { Provider: Provider, connect: connect, connectAdvanced: connectAdvanced };

var LoginCallback = function (_Component) {
  inherits(LoginCallback, _Component);

  function LoginCallback() {
    classCallCheck(this, LoginCallback);
    return possibleConstructorReturn(this, (LoginCallback.__proto__ || Object.getPrototypeOf(LoginCallback)).apply(this, arguments));
  }

  createClass(LoginCallback, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var usp = new URLSearchParams(window.location.search);
      if (!usp.has("token")) {
        this.props.dispatch(addNotification(NOTIFICATION_LEVEL_WARNING, "no token, try again"));
      } else {
...
var LoginCallback$1 = index$1$1.connect(mapStateToProps)(LoginCallback);
...
var Logout = function (_Component) {
  inherits(Logout, _Component);

  function Logout() {
    classCallCheck(this, Logout);

    var _this = possibleConstructorReturn(this, (Logout.__proto__ || Object.getPrototypeOf(Logout)).call(this));
...
var Nav$1 = index$1$1.connect(mapStateToProps$1)(Nav);

var NotFound = (function (_ref, _ref2) {
  var type = _ref.type,
      url = _ref.url;
  objectDestructuringEmpty(_ref2);
  return h(
...
var Notification = function (_Component) {
  ...
  createClass(Notification, [{
    ...
    key: "render",
    value: function render$$1(props, state) {
      var style = props.level === NOTIFICATION_LEVEL_WARNING ? "flex items-center justify-center pa2 " + "bg-washed-red" : "flex items-center justify-center pa2 " + "bg-lightest-blue";
      return h(
        "div",
        { "class": style, onClick: this.handleClick },
        h(
          "span",
          { "class": "lh-title ml1" },
          props.message
...
var NotificationWindow = function (_Component) {
  inherits(NotificationWindow, _Component);

  function NotificationWindow() {
    classCallCheck(this, NotificationWindow);
    return possibleConstructorReturn(this, (NotificationWindow.__proto__ || Object.getPrototypeOf(NotificationWindow)).apply(this, arguments));
  }

  createClass(NotificationWindow, [{
    key: "render",
    value: function render$$1(props, state) {
...
var NotificationWindow$1 = index$1$1.connect(mapStateToProps$2)(NotificationWindow);

var RehydrateProvider = function (_Component) {
  inherits(RehydrateProvider, _Component);

  function RehydrateProvider() {
    classCallCheck(this, RehydrateProvider);

    var _this = possibleConstructorReturn(this, (RehydrateProvider.__proto__ || Object.getPrototypeOf(RehydrateProvider)).call(this));

    _this.state = { rehydrated: false };
    return _this;
  }

  createClass(RehydrateProvider, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var _this2 = this;

      persistStore(this.props.store, { blacklist: ["routing"] }, function () {
...
var TextContent = function (_Component) {
  ...
  function TextContent() {
    ...
    return possibleConstructorReturn(this, (TextContent.__proto__ || Object.getPrototypeOf(TextContent)).apply(this, arguments));
  }

  createClass(TextContent, [{
    key: "render",
    value: function render$$1(_ref, _ref2) {
  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        h(Route, { path: "/login-callback", component: LoginCallback$1 }),
        h(Route, { component: NotFound, "default": true })
      ),
      h(Footer, null)
    )
  );
