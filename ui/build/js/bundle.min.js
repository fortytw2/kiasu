  ...
  activateToken: function(token) {
    return mithril
      ...
      .then(function(result) {
        ...
        flash$1.flashMessage = "logged in ok";
      });
  },
  requestToken: function(email) {
    return mithril
      ...
      .catch(function(error) {
        singleton.captureException(error);
      });
  }
};
...
var logincallback = {
  oncreate(vnode) {
    user.activateToken(mithril.route.param("key"));
  },
  view(vnode) {
    return mithril.route.set("/");
  }
};
...
mithril.route(document.body, "/", {
  ...
  "/login-callback": {
    render: function() {
      return mithril(layout, mithril(logincallback));
    }
  }
});
