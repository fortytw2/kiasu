...
var Store = compose(autoRehydrate({ log: true }))(createStore)(combineReducers(reducers), window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
...
selectorFactory) {
  ...
  var connectOptions = objectWithoutProperties$1(_ref, ['getDisplayName', 'methodName', 'renderCountProp', 'shouldHandleStateChanges', 'storeKey', 'withRef']);
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    return index$2(Connect, WrappedComponent);
  };
}
...
function whenMapDispatchToPropsIsObject(mapDispatchToProps) {
  return mapDispatchToProps && (typeof mapDispatchToProps === 'undefined' ? 'undefined' : _typeof$4(mapDispatchToProps)) === 'object' ? wrapMapToPropsConstant(function (dispatch) {
...
function finalPropsSelectorFactory(dispatch, _ref2) {
  ...
  var options$$1 = objectWithoutProperties$1(_ref2, ['initMapStateToProps', 'initMapDispatchToProps', 'initMergeProps']);
...
function match(arg, factories, name) {
  ...
  return function (dispatch, options$$1) {
    throw new Error('Invalid value of type ' + (typeof arg === 'undefined' ? 'undefined' : _typeof$4(arg)) + ' for ' + name + ' argument when connecting component ' + options$$1.wrappedComponentName + '.');
  };
}
...
function createConnect() {
  ...
  return function connect(mapStateToProps, mapDispatchToProps, mergeProps) {
    ...
    var extraOptions = objectWithoutProperties$1(_ref2, ['pure', 'areStatesEqual', 'areOwnPropsEqual', 'areStatePropsEqual', 'areMergedPropsEqual']);
...
var LoginCallback$1 = lib$1.connect(mapStateToProps)(LoginCallback);
...
var Nav$1 = lib$1.connect(mapStateToProps$1)(Nav);
...
var NotificationWindow$1 = lib$1.connect(mapStateToProps$2)(NotificationWindow);
...
var RehydrateProvider = function (_Component) {
  ...
  createClass(RehydrateProvider, [{
    ...
    value: function componentWillMount() {
      ...
      persistStore(this.props.store, {}, function () {
