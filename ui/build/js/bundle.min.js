  ...
  return function (state, action) {
    ...
    if (action.type === PERSIST) {
      ...
      if (_purge) return _extends$1({}, restState, {
        ...
        return _extends$1({}, reconciledRest, {
          _persist: _extends$1({}, _persist, { rehydrated: true })
        });
      }
    }
    ...
    var newState = _extends$1({}, baseReducer(restState, action), {
      _persist: _persist
...
function autoMergeLevel2(inboundState, originalState, reducedState, _ref) {
  ...
  var newState = _extends$3({}, reducedState);
  // only rehydrate if inboundState exists and is an object
  if (inboundState && (typeof inboundState === 'undefined' ? 'undefined' : _typeof$1(inboundState)) === 'object') {
    Object.keys(inboundState).forEach(function (key) {
      ...
      if (isPlainEnoughObject(reducedState[key])) {
        ...
        newState[key] = _extends$3({}, newState[key], inboundState[key]);
        return;
      }
      // otherwise hard set
      newState[key] = inboundState[key];
...
function isPlainEnoughObject(o) {
  return o !== null && !Array.isArray(o) && (typeof o === 'undefined' ? 'undefined' : _typeof$1(o)) === 'object';
}
...
var storage = createWebStorage('local');
...
var Store = createStore(persistCombineReducers(config, {
  login: login,
...
var index$1 = { Provider: Provider, connect: connect, connectAdvanced: connectAdvanced };
...
var LoginCallback$1 = index$1.connect(mapStateToProps)(LoginCallback);
...
var Nav$1 = index$1.connect(mapStateToProps$1)(Nav);
...
var NotificationWindow$1 = index$1.connect(mapStateToProps$2)(NotificationWindow);
